...
class _ProveedoresWidgetState extends State<ProveedoresWidget> {
  ...
  void initState() {
    ...
    _model.txtNombrePTextController ??= TextEditingController();
    _model.txtNombrePFocusNode ??= FocusNode();
            ...
            child: Column(
              ...
              children: [
                      ...
                      Expanded(
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              20.0, 0.0, 20.0, 0.0),
                          child: TextFormField(
                            controller: _model.txtNombrePTextController,
                            focusNode: _model.txtNombrePFocusNode,
                            autofocus: true,
                            obscureText: false,
                            ...
                            validator: _model.txtNombrePTextControllerValidator
                                .asValidator(context),
                          ),
                        ),
                      ),
                ...
                Opacity(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await ProveedoresRecord.collection
                            .doc()
                            .set(createProveedoresRecordData(
                              nombre: _model.txtNombrePTextController.text,
                              direccion: _model.txtDireccionTextController.text,
                              telefono: _model.txtTelefonoTextController.text,
                              correo: _model.txtCorreoTextController.text,
                            ));
                        setState(() {
                          _model.txtNombrePTextController?.clear();
                          _model.txtDireccionTextController?.clear();
                        ...
                        await showDialog(
                          ...
                          builder: (alertDialogContext) {
                            return AlertDialog(
                              title: Text('Proveedor Agregado'),
                              content:
                                  Text('Se ha ingresado un nuevo proveedor'),
                              actions: [
                                TextButton(
                                  onPressed: () =>
                ...
                Padding(
                  ...
                  child: StreamBuilder<List<ProveedoresRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<ProveedoresRecord> listViewProveedoresRecordList =
                          snapshot.data!;
                      ...
                      return ListView.builder(
                        ...
                        itemCount: listViewProveedoresRecordList.length,
                        itemBuilder: (context, listViewIndex) {
                          final listViewProveedoresRecord =
                              listViewProveedoresRecordList[listViewIndex];
                          return Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                5.0, 0.0, 0.0, 5.0),
                            child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            Text(
                                              listViewProveedoresRecord.nombre,
                                              style:
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text(
                                              listViewProveedoresRecord.correo,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
                                          ...
                                          children: [
                                            InkWell(
                                              ...
                                              highlightColor:
                                                  Colors.transparent,
                                              onTap: () async {
                                                await listViewProveedoresRecord
                                                    .reference
                                                    .delete();
                                                await showDialog(
                                                  context: context,
