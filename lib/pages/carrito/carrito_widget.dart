...
class CarritoWidget extends StatefulWidget {
  const CarritoWidget({
    ...
    required this.tallaProduc,
  });

  final String? fotoProducto;
  final String? nombreProducto;
  final double? precioProducto;
  final String? tallaProduc;
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            appBar: PreferredSize(
              ...
              child: AppBar(
                backgroundColor: Color(0xFFD7CAE0),
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            '₡${functions.totalList(carritoCarritoRecordList.map((e) => e.subTotal).toList()).toString()}',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  fontFamily: 'Poppins',
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Text(
                                                    '₡${listViewCarritoRecord.precioProducto.toString()}',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        ...
                                        content: Text(
                                            'Contacte con la tienda para coordinar la entrega al siguente número +506 83994559'),
                                        actions: [
                                          TextButton(
